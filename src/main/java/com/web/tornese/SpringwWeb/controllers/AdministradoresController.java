...
import com.web.tornese.SpringwWeb.models.Administrador;
import com.web.tornese.SpringwWeb.repositorio.AdministradoresRepo;
...
public class AdministradoresController {
	...
	public String busca(@PathVariable int id, Model model) {
		...
		}catch(Exception erro){return "redirect:/administradores";}
